...
from generate_series('2017-03-13', '2017-04-03', '1 week'::interval) i),
...
where 1=1
and country like 'ES'
and acquisition_channel not like 'Sales'
...
and date_trunc ('week', registration_date) >= '2017-03-20'
),
...
row_number () over (partition by pay.user_id order by created) as pur_order
